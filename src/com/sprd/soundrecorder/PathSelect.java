...
//      requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    private void initializeList() {
        String sdState = StandardFrameworks.getInstances().getExternalStoragePathState();
        String internalState = StandardFrameworks.getInstances().getInternalStoragePathState();
        File internalPath = StandardFrameworks.getInstances().getInternalStoragePath();
        File externalPath = StandardFrameworks.getInstances().getExternalStoragePath();
