...
public class LocalPreviewPlayer extends MediaPlayer implements OnPreparedListener,
        OnErrorListener, OnCompletionListener {

    public static String TAG = "PreviewPlayer";
    private LocalRecordFragment mActivity;
    ...
    public void setActivity(Context context,LocalRecordFragment RecordFragment ) {
