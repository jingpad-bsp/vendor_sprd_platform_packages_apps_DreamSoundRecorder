...
public class PathSelectAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (items.get(position).toString().equals("back")) {
            ...
            /* SPRD: fix bug 546490 @{ */
            if (f.getPath().equals(StandardFrameworks.getInstances().getInternalStoragePath().getPath())) {
            ...
            } else if (f.getPath().equals(StandardFrameworks.getInstances().getExternalStoragePath().getPath())) {
